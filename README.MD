...
A principal funcionalidade dessa API é permitir o cadastro de usuários para manipular de maneira individual uma carteira, inserindo, alterando, removendo ou adicionado itens.
...
```
git clone https://github.com/vicmota98/walletAPI
cd walletAPI
mvn spring-boot:run
...
### Heroku
A aplicação está disponível no heroku através da url https://apiwallet2021.herokuapp.com/