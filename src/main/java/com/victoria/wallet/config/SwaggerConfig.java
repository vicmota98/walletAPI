package com.victoria.wallet.config;

import com.victoria.wallet.security.config.SecurityConfiguration;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        ...
        .apis(RequestHandlerSelectors.basePackage("com.victoria.wallet.controller"))
